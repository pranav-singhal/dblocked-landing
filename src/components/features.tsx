import { Mic, Book, DollarSign, Cable, Trophy, Computer } from "lucide-react";
...
export function Features() {
  return (
    <section className="container flex flex-col items-center gap-6 py-24 sm:gap-7">
      ...
      <p className="text-lg text-muted-foreground text-center max-w-2xl hidden">
        ...
        <Card className="shadow-lg">
          <CardContent className="flex flex-col items-start gap-5 p-7">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Our business is completely B2B. Which means, &quot;0 to web3&quot; will always
                remain free for developers.
              </p>
            </div>
          </CardContent>
        </Card>
